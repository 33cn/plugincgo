...
public class Blockchain {
    ...
    public static native long getCurrentHeight();

    // stop the current transaction with the error info
    public static native boolean stopTransWithErrInfo(String errInfo);
