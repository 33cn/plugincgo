...
public class LocalDB {
    ...
    public static native boolean setLocal(byte[] key, byte[] value);

    // get value from local db
    public static native byte[] getFromLocal(byte[] key);

    // set value to local db in format of string
    public static native boolean setLocalInStr(String key, String value);

    // get value from local db in format of string
    public static native String getFromLocalInStr(String key);
